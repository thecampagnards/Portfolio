<?php
	...
	if(!empty($_SESSION['utilisateur'])) {
		$sectionMenu2 = '<a href="compte"><span>Compte</span><i class="icon-user-1"></i></a>';
		$sectionMenu4 = '<a href="index.php?page=compte&action=deconnexion"><span>Déconnexion</span></a>';
		$state = 'connecte';
		
	} else {
		$sectionMenu2 = '<a href="inscription"><span>Inscription</span><i class="icon-plus"></i></a>';
		$sectionMenu4 = '<a href="connexion"><span>Connexion</span></a>';
		$state = 'deconnecte';
	}
